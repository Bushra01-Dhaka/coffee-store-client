...
const UpdateCoffee = () => {
    ...
    const handleUpdateCoffee = e => 
    {
       ...
       const newUpdatedCoffeeInfo = {name,quantity, supplier, taste, category, details, photo};
       console.log(newUpdatedCoffeeInfo);
       ...
       fetch(`http://localhost:5000/coffee/${_id}`, {
        ...
        body: JSON.stringify(newUpdatedCoffeeInfo)
     ...
     <div className="navbar bg-yellow-800 text-white">
        ...
        <div className="container mx-auto bg-[#F4F3F0] p-8">
          <div>
            ...
            {/* button */}
            <input type="submit" value="Update Coffee" className="btn btn-block bg-yellow-800 text-white hover:bg-yellow-700" />
